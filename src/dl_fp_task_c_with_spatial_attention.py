# -*- coding: utf-8 -*-
"""DL_FP_Task C_with Spatial_Attention.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wn_Q4ILUHmFWdrDNCgKGClx6TFVyK8BD
"""
...
def evaluate_model(model, test_loader, device, test_only=False, prediction_path=""):
    ...
    all_image_ids = []
    val_loss = []
    criterion = nn.CrossEntropyLoss()  # Add loss calculation for validation
...
def plot_training_results(metrics, save_path="training_results_Task C-Spatial_Attention.png"):
    ...
    fig.suptitle("Training and Validation Metrics from C-Spatial_Attention", fontsize=16)
...
def plot_confusion_matrix(model, val_loader, device, class_names, save_path="confusion_matrix_task C-Spatial_Attention.png"):
...
#    )
    ...
    model_name = f"./model_{mode}_run_taskC_Spatial_Attention.pth"
    ...
    try:
        ...
        # Call visualization
        plot_training_results(metrics, save_path="task_C-Spatial_Attention_training_results.png")

        # Define class names for your DR levels
        class_names = ["No DR", "Mild", "Moderate", "Severe", "Proliferative DR"]

        # Plot confusion matrix
        plot_confusion_matrix(model, val_loader, device, class_names, save_path="task_C-Spatial_Attention_confusion_matrix.png")
