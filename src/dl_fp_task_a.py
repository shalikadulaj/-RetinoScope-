...
Original file is located at
    https://colab.research.google.com/drive/1A41olxRcB3spFh4TssUWbaCBy4pRB_0F
"""
...
def plot_training_results(metrics, save_path="training_results_Task A.png"):
...
def plot_confusion_matrix(model, val_loader, device, class_names, save_path="confusion_matrix_task A.png"):
...
#    )
    ...
    model_name = f"./model_{mode}_run_taskA.pth"
    ...
    try:
        ...
        state_dict = torch.load(model_name, map_location='cpu')  # Use generated model_name here
        ...
        # Call visualization
        plot_training_results(metrics, save_path="task_A_training_results.png")

        # Define class names for your DR levels
        class_names = ["No DR", "Mild", "Moderate", "Severe", "Proliferative DR"]

        # Plot confusion matrix
        plot_confusion_matrix(model, val_loader, device, class_names, save_path="task_A_confusion_matrix.png")
