...
def plot_training_results(metrics, save_path="training_results_Task B-vgg16-DeepDRid.png"):
    ...
    fig.suptitle("Training and Validation Metrics from Task B-vgg16-DeepDRid", fontsize=16)
...
def plot_confusion_matrix(model, val_loader, device, class_names, save_path="confusion_matrix_task B-vgg16-DeepDRid.png"):
...
#        name="Task B-vgg16 - Two Stage Training with APTOS",
#        resume=False
#    )
    ...
    fine_tuned_weights = 'B3_model.pth'
    ...
    try:
        ...
        # Call visualization
        plot_training_results(metrics, save_path="task_B-vgg16-DeepDRid_training_results.png")

        # Define class names for your DR levels
        class_names = ["No DR", "Mild", "Moderate", "Severe", "Proliferative DR"]

        # Plot confusion matrix
        plot_confusion_matrix(model, val_loader, device, class_names, save_path="task_B-vgg16-DeepDRid_confusion_matrix.png")
