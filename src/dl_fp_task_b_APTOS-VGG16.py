...
def plot_training_results(metrics, save_path="training_results_Task B-APTOS-vgg16.png"):
...
def plot_confusion_matrix(model, val_loader, device, class_names, save_path="confusion_matrix_task B-APTOS-vgg16.png"):
...
#    )
    ...
    try:
        ...
        # Call visualization
        plot_training_results(metrics, save_path="task_B-vgg16_training_results.png")

        # Define class names for your DR levels
        class_names = ["No DR", "Mild", "Moderate", "Severe", "Proliferative DR"]

        # Plot confusion matrix
        plot_confusion_matrix(model, val_loader, device, class_names, save_path="task_B-vgg16_confusion_matrix.png")
