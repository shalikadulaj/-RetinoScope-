...
def plot_training_results(metrics, save_path="training_results_Task B-APTOS-resnet34.png"):
...
def plot_confusion_matrix(model, val_loader, device, class_names, save_path="confusion_matrix_task B-APTOS-resnet34.png"):
...
#        name="DL_FP_task B - run #1 - resnet34",
#        resume=False
#    )
    ...
    try:
        ...
        # Call visualization
        plot_training_results(metrics, save_path="task_B-resnet34_training_results.png")

        # Define class names for your DR levels
        class_names = ["No DR", "Mild", "Moderate", "Severe", "Proliferative DR"]

        # Plot confusion matrix
        plot_confusion_matrix(model, val_loader, device, class_names, save_path="task_B-resnet34_confusion_matrix.png")
