...
def plot_training_results(metrics, save_path="training_results_Task B-resnet34-DeepDRid.png"):
    ...
    fig.suptitle("Training and Validation Metrics from Task B-resnet34-DeepDRid", fontsize=16)
...
def plot_confusion_matrix(model, val_loader, device, class_names, save_path="confusion_matrix_task B-resnet34-DeepDRid.png"):
...
#        name="Task B-resnet34 - Two Stage Training with APTOS",
#        resume=False
#    )
    ...
    fine_tuned_weights = 'B2_model.pth'
