# -*- coding: utf-8 -*-
"""DL_FP_Task B-II.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IvavURi4xxDhziOPmZp6LDpGfFCyO6XF
"""
...
class MyDualModel(nn.Module):
    def __init__(self, num_classes=5, dropout_rate=0.62):
        ...
        # Two backbones with unshared weights
...
def plot_training_results(metrics, save_path="training_results_Task B-DeepDRid.png"):
    ...
    fig.suptitle("Training and Validation Metrics from Task B-DeepDRid", fontsize=16)
...
def plot_confusion_matrix(model, val_loader, device, class_names, save_path="confusion_matrix_task A-DeepDRid.png"):
...
#        name="Task B - Two Stage Training with APTOS",
#        resume=False
#    )
    ...
    model_name = f"./model_{mode}_run_taskB2_DeepDRid.pth"
    ...
    fine_tuned_weights = 'model_dual_run_taskB_APTOS.pth'
    ...
    optimizer = torch.optim.Adam(params=model.fc.parameters(), lr=learning_rate,weight_decay=0.01) #L2 added
    ...
    try:
        ...
        model, metrics = train_model(
            ...
            lr_scheduler= None, num_epochs=num_epochs,
        ...
        # Call visualization
        plot_training_results(metrics, save_path="task_B-DeepDRid_training_results.png")

        # Define class names for your DR levels
        class_names = ["No DR", "Mild", "Moderate", "Severe", "Proliferative DR"]

        # Plot confusion matrix
        plot_confusion_matrix(model, val_loader, device, class_names, save_path="task_B-DeepDRid_confusion_matrix.png")
